...
$sql = "SELECT * FROM berichten WHERE user_id = '" . $user_id . "'";
...
<h1 class="header-title">Mijn Berichten</h1>
<div class="witruimte"></div>
<div class="witruimte"></div>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <div class="msg-titel"> ' . $row["subject"]. ' </div> 
    ...
    echo "<p class='header-title2'>Je hebt nog geen berichten, klik <a href='forum.php'>hier</a> om een bericht achter te laten";
}
$con->close();
?>
