...
<body>
    ...
    <div id="bg-nav">
        <a href="admin-dash.php">
            <img src="img/mclogosmall2.jpg" class="toplogo" href="admin-dash.php">
        </a>
        </div>
        <div id="menu">
            <nav id="login-nav">
...
<div class="side-nav">
  ...
  <a href="berichten.php">Alle Berichten</a>
  <a href="admin-signup.php">Voeg admin toe</a>
</div>
...
<h1 class="account-info-txt">Naam: <?php echo $admin_data['firstname']; ?> <?php echo $admin_data['lastname']; ?></h1>
</div>
<div class="account-info-div">
<h1 class="account-info-txt">Email: <?php echo $admin_data['email']; ?></h1>
</div>
<div class="account-info-div">
<h1 class="account-info-txt">Telfoonnummer: <?php echo $admin_data['phone']; ?></h1>
</div>
<div class="account-info-div">
<h1 class="account-info-txt">Gebruikersnaam: <?php echo $admin_data['username']; ?></h1>
</div>
<div class="account-info-div-onder">
<h1 class="account-info-txt">Persoonlijke id: <?php echo $admin_data['admin_id']; ?></h1>
</div>
</div>
<div class="witruimte"></div>
<div class="witruimte"></div>
