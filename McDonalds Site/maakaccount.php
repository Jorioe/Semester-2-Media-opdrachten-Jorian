...
<body>
    ...
    <div id="bg-nav">
        ...
        <div id="menu">
            <nav id="login-nav">
                <ul>
                    <li><a class="active" href="login.php"><i class="fa fa-user"></i> Log In</span></a></li><!--
...
<h1 class="header-title">Oeps...</h1>
<div class="witruimte2"></div>
<div class="welkom-container">
<h1 class="header-title2">U moet eerst een account aanmaken.</h1>
<h1 class="header-title2"><a href="signup.php">Maak account aan</a></h1>
<div class="witruimte"></div>
<div class="witruimte"></div>
<div class="witruimte"></div>   
<h1 class="header-txt">Al een account? <a href="login.php">Log in</a></h1>
</div>
<div class="witruimte"></div>
<div class="witruimte"></div>
<div class="witruimte"></div>
