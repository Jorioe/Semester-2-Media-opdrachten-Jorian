...
<h1 class="header-title-naam"><?php echo $user_data['firstname']; ?> <?php echo $user_data['lastname']; ?></h1>
</div>
<div class="witruimte"></div>
<div class="witruimte"></div>
<div id="app-box">
<h1 class="header-title2">Stel je vraag!</h1>
<h2 class="header-txt">Stuur <a href="forum.php">hier</a> je vraag in voor de hosts van de McPodcast en wieweet wordt jouw vraag beantwoord in de volgende editie van de McPodcast.</h2>
</div>
<div class="witruimte"></div>
<div class="witruimte"></div>
<div class="witruimte"></div>
